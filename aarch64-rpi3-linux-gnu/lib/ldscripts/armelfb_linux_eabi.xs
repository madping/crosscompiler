...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/Volumes/case_sencitive/x-tools/aarch64-rpi3-linux-gnu/aarch64-rpi3-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
